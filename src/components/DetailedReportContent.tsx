...
export const DETAILED_REPORT_PDF_ROOT_ID = 'detailed-report-pdf-root';

interface DetailedReportContentProps {
  analysisData: AnalysisData;
}

/** Report body shared by the on-screen DetailedReport page and PDF export. */
export function DetailedReportContent({ analysisData }: DetailedReportContentProps) {
  ...
  return (
    <div
      id={DETAILED_REPORT_PDF_ROOT_ID}
      dir="rtl"
      className="max-w-5xl mx-auto space-y-6 bg-white text-gray-900"
    >
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                تم الإنشاء في{' '}
                {new Date(analysisData.uploadDate).toLocaleDateString('ar-SA', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric',
                })}
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent>
          <p className="text-gray-700 leading-relaxed">{analysisData.executiveSummary}</p>
        </CardContent>
      </Card>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  {analysisData.linguisticAnalysis.grammaticalComplexity}/100 - تعقيد معتدل مع بعض
                  الهياكل المتقدمة
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  {analysisData.linguisticAnalysis.stylisticDiversity}/100 - تنوع جيد مع مجال
                  للتحسين
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  {analysisData.linguisticAnalysis.textSimplicity}/100 - يمكن الوصول إليه بشكل
                  مناسب للمستوى المستهدف
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                <p className="text-gray-600 mb-1">سهولة اللغة</p>
                <p className="text-gray-900">
                  {analysisData.linguisticAnalysis.languageEase}/100 - قابل للقراءة بشكل عام مع
                  تحديات طفيفة
                </p>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.semanticAnalysis.ambiguity < 30
                    ? ' الحد الأدنى من الغموض المكتشف'
                    : analysisData.semanticAnalysis.ambiguity < 60
                      ? ' غموض معتدل'
                      : ' غموض عالي'}
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.semanticAnalysis.repetition < 30
                    ? ' تكرار منخفض'
                    : analysisData.semanticAnalysis.repetition < 60
                      ? ' تكرار معتدل'
                      : ' تكرار عالي'}
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.semanticAnalysis.conceptualGap < 30
                    ? ' استمرارية مفاهيمية قوية'
                    : analysisData.semanticAnalysis.conceptualGap < 60
                      ? ' استمرارية معتدلة'
                      : ' فجوات كبيرة'}
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.semanticAnalysis.semanticLinks >= 80
                    ? ' أفكار ومفاهيم متصلة بشكل جيد'
                    : analysisData.semanticAnalysis.semanticLinks >= 60
                      ? ' روابط جيدة'
                      : ' روابط ضعيفة'}
                </p>
              </div>
            ...
            <div className="grid sm:grid-cols-3 gap-4 text-sm">
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.contentOrganization.structureQuality >= 80
                    ? ' محتوى منظم بشكل جيد'
                    : analysisData.contentOrganization.structureQuality >= 60
                      ? ' منظم بشكل معتدل'
                      : ' يحتاج تحسين'}
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.contentOrganization.learningProgression >= 80
                    ? ' تدفق منطقي للمفاهيم'
                    : analysisData.contentOrganization.learningProgression >= 60
                      ? ' تدفق معتدل'
                      : ' يحتاج تحسين'}
                </p>
              </div>
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-gray-900">
                  ...
                  {analysisData.contentOrganization.contentRelevance >= 80
                    ? ' ذو صلة عالية بالأهداف'
                    : analysisData.contentOrganization.contentRelevance >= 60
                      ? ' صلة معتدلة'
                      : ' صلة منخفضة'}
                </p>
              </div>
